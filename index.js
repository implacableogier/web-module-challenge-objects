...
function createMenuItem (name, price, category){
  //return values  equal to the specified parameters
 ...
 console.log(createMenuItem('testing', 'testing2', 'testing3'))
...
reviews[7].feedback = 'this place is chill with really cool people, great for getting work done on weedays';
...
function getLastReview(array) {
    const mostRecent = reviews.length-1

    const name = array[mostRecent].name
    const rating = array[mostRecent].rating
    const feedback = array[mostRecent].feedback
